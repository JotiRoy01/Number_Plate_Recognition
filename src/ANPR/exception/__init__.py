...
class ANPR_Exceptioon(Exception) :
    def __init__(self, error_message:Exception, error_detail:sys):
        super().__init__(error_message)
        self.error_message = ANPR_Exceptioon.get_detailed_error_message(error_message=error_message,
    ...
    def __repr__(self):
        return ANPR_Exceptioon.__name__.str()
